...
export const LoginForm = () => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                if (role === 'admin_competition') {
                    navigate('/login/createTournament');
                } else {
    ...
    return (
        <div className='p-28 flex flex-col md:flex-row items-center justify-center '>
            <Card className='w-[385px] border-none rounded-none'>
                <img src={poster} alt="" className='h-full w-full object-cover' />
            </Card>
            <Card className='p-8 rounded shadow-lg max-w-md w-full lg:w-full '>
