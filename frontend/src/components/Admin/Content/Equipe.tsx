...
type EntryType = "equipes" | "arbitres" | "administrateurs";
...
export const Equipe = () => {
  ...
  const [modalType, setModalType] = useState<EntryType>("equipes");
  ...
  const handleEdit = (index: number, value: string, type: EntryType) => {
    setEditIndex(index);
    setEditValue(value);
    setModalType(type);
    setShowModal(true);
  ...
  const handleDelete = (index: number, type: EntryType) => {
    setEntries((prev) => ({
      ...prev,
    ...
    <div className="container mx-auto p-16">
      <Card className="navParticipants">
        <ul className="flex flex-row gap-5 justify-around items-center text-lg cursor-pointer">
          <li
            className={toggle === 1 ? "block border-b-2 w-40 text-center border-b-blue-500 cursor-pointer" : "border-none"}
            onClick={() => isToggle(1)}
          >
            Equipe
          </li>
          <li
            className={toggle === 2 ? "block border-b-2 w-40 text-center border-b-blue-500 cursor-pointer" : "border-none"}
            onClick={() => isToggle(2)}
          >
            Arbitre
          </li>
          <li
            className={toggle === 3 ? "block border-b-2 w-40 text-center border-b-blue-500 cursor-pointer" : "border-none"}
            onClick={() => isToggle(3)}
          >
            Administrateur
          </li>
      ...
      <div className={toggle === 1 ? "block" : "hidden"}>
        <div className="flex flex-col md:flex-row items-center justify-center ">
          ...
          <Modal
            ...
            onSave={handleSave}
            titre={editIndex !== null ? "Modifier une équipe" : "Ajouter une équipe"}
            content="Contenu de la boîte modale"
            ...
            <div className="w-full mt-6">
              ...
              <ul className="list-disc pl-5">
                {entries.equipes.map((equipe, index) => (
                  <li className="border-b-2 border-gray-300 py-2 flex justify-between items-center" key={index}>
                    {equipe}
                    <div className="flex gap-2">
                      <Button className="bg-gray-500 text-white px-2 py-1 rounded" onClick={() => handleEdit(index, equipe, "equipes")}>
                        Modifier
                      </Button>
                      <Button className="bg-red-500 text-white px-2 py-1 rounded" onClick={() => handleDelete(index, "equipes")}>
                        Supprimer
                      </Button>
                      <Button className="bg-blue-500 text-white px-2 py-1 rounded" onClick={() => setShowPlayerManager(true)}>
                        <LucideUser size={20} />
              ...
              <Button className="mt-4  px-4 py-2 rounded" onClick={() => handleOpenModal("equipes")}>
                Ajouter une équipe
              </Button>
            </div>
          )}
      ...
      <div className={toggle === 2 ? "block" : "hidden"}>
        <div className="flex flex-col md:flex-row items-center justify-center">
          ...
          <Modal
            ...
            onClose={handleCloseModal}
            onSave={handleSave}
            titre={editIndex !== null ? "Modifier un arbitre" : "Ajouter un arbitre"}
            content="Contenu de la boîte modale"
          ...
          {showArbitreList && (
            <div className="w-full mt-6">
              ...
              <ul className="list-disc pl-5">
                {entries.arbitres.map((arbitre, index) => (
                  <li className="border-b-2 border-gray-300 py-2 flex justify-between items-center" key={index}>
                    {arbitre}
                    <div className="flex gap-2">
                      <Button className="bg-gray-500 text-white px-2 py-1 rounded" onClick={() => handleEdit(index, arbitre, "arbitres")}>
                        Modifier
                      </Button>
                      <Button className="bg-red-500 text-white px-2 py-1 rounded" onClick={() => handleDelete(index, "arbitres")}>
                        Supprimer
                      </Button>
                    </div>
                  </li>
              ...
              <Button className="mt-4  px-4 py-2 rounded" onClick={() => handleOpenModal("arbitres")}>
                Ajouter un arbitre
              </Button>
            </div>
          )}
      ...
      <div className={toggle === 3 ? "block" : "hidden"}>
        <div className="flex flex-col md:flex-row items-center justify-center">
          ...
          <Modal
            ...
            onClose={handleCloseModal}
            onSave={handleSave}
            titre={editIndex !== null ? "Modifier un administrateur" : "Ajouter un administrateur"}
            content="Contenu de la boîte modale"
          ...
          {showAdminList && (
            <div className="w-full mt-6">
              ...
              <ul className="list-disc pl-5">
                {entries.administrateurs.map((admin, index) => (
                  <li className="border-b-2 border-gray-300 py-2 flex justify-between items-center" key={index}>
                    {admin}
                    <div className="flex gap-2">
                      <Button className="bg-gray-500 text-white px-2 py-1 rounded" onClick={() => handleEdit(index, admin, "administrateurs")}>
                        Modifier
                      </Button>
                      <Button className="bg-red-500 text-white px-2 py-1 rounded" onClick={() => handleDelete(index, "administrateurs")}>
                        Supprimer
                      </Button>
                    </div>
                  </li>
              ...
              <Button className="mt-4  px-4 py-2 rounded" onClick={() => handleOpenModal("administrateurs")}>
