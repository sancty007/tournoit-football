...
export const Equipe = () => {
    ...
    const handleEdit = (index: number, value: string, type: "equipes" | "arbitres" | "administrateurs") => {
        setEditIndex(index);
        setEditValue(value);
        setModalType(type);
        setShowModal(true);
    ...
    const handleDelete = (index: number, type: "equipes" | "arbitres" | "administrateurs") => {
        setEntries((prev) => ({
            ...prev,
                                ...
                                {entries.administrateurs.map((administrateur, index) => (
                                    <li className="border-b-2 border-gray-300 py-2 flex justify-between items-center" key={index}>
                                        ...
                                        <div className="flex gap-2">
                                            <Button 
                                                className="bg-gray-500 text-white px-2 py-1 rounded"
                                                onClick={() => handleEdit(index, administrateur, "administrateurs")}
                                            >
                                                Modifier
                                            </Button>
                                            <Button 
